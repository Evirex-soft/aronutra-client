...
import { ArrowRight, ShoppingBag, Award, CheckCircle2 } from "lucide-react";
        ...
        <div className="pt-32 pb-24 bg-[#052c22] min-h-screen">
            <div className="max-w-[1400px] mx-auto px-6 lg:px-20">
                ...
                <section className="mb-24 relative">
                    <div className="bg-linear-to-br from-[#d4af37] via-[#f2dd8b] to-[#d4af37] rounded-[3rem] p-8 lg:p-16 flex flex-col lg:flex-row items-center gap-12 overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.4)] relative group">

                        {/* Decorative Background Elements */}
                        <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl -mr-20 -mt-20 group-hover:scale-125 transition-transform duration-1000" />

                        <div className="flex-1 space-y-8 relative z-10">
                            <div className="inline-flex items-center gap-3 bg-[#052c22] text-white px-5 py-2 rounded-full">
                                <Award size={14} className="text-[#d4af37]" />
                                <span className="text-[10px] font-black uppercase tracking-[0.3em]">The Signature Collection</span>
                            </div>
                            ...
                            <p className="text-[#052c22]/70 text-lg lg:text-xl font-light italic max-w-xl leading-relaxed">
                                Experience the full artisanal spectrum. A curated package containing one 50g jar of every unique monofloral variety we harvest.
                            </p>

                            <div className="grid grid-cols-2 gap-y-4 gap-x-8 max-w-md pb-4">
                                {["12 Unique Jars", "50g Per Variety", "Signature Gift Box", "Limited Harvest"].map((feat) => (
                                    <div key={feat} className="flex items-center gap-2 text-[#052c22] text-[10px] font-black uppercase tracking-widest">
                                        <CheckCircle2 size={14} className="opacity-50" /> {feat}
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="w-full lg:w-auto relative z-10">
                            <div className="bg-[#052c22] p-10 lg:p-12 rounded-[2.5rem] text-white text-center shadow-2xl lg:min-w-[320px]">
                                <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#d4af37] mb-4">Complete Package</p>

                                <div className="space-y-1 mb-10">
                                    <p className="text-5xl font-light">₹{bundlePrice.toLocaleString()}</p>
                ...
                <header className="mb-20">
                    ...
                    <h2 className="font-medium text-4xl md:text-5xl text-white tracking-tight">
                        Single-Origin Jars
                    </h2>
                </header>
