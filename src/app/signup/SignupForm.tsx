            ...
            <motion.div variants={fadeInUp} className="bg-white/[0.03] backdrop-blur-xl border border-white/10 p-8 md:p-10 shadow-2xl">
                <form onSubmit={handleSignup} className="space-y-5">
                    ...
                    <motion.button
                        ...
                        className="w-full bg-[#c5a358] text-[#052c22] font-bold py-4 mt-6 flex items-center justify-center gap-3 transition-all relative overflow-hidden group disabled:opacity-50"
                    >
                        {loading ? (
