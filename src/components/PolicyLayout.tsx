...
const PolicyLayout: React.FC<PolicyLayoutProps> = ({ children, title }) => {
  return (
    <div className="min-h-screen pt-16 flex flex-col bg-gradient-to-br from-stone-50 via-[#FCFBFA] to-stone-100/30 text-stone-800">
      <main className="flex-grow py-16 md:py-20 px-6 sm:px-8 lg:px-12">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl border border-stone-200/50 shadow-[0_25px_60px_rgba(0,0,0,0.02)] p-8 md:p-12">
          {/* Page Title */}
          <h1 className="text-3xl md:text-4xl font-black text-stone-900 mb-8 pb-4 border-b border-stone-200/60 text-center font-serif tracking-tight">
            {title}
          </h1>
